...
const DropZone = ({ data, dispatch }) => {
  ...
  return (
    <>
      ...
      <div className={data.fileList.length > 0 ? "flex justify-between w-[60%]" : "flex justify-center w-[60%]"}>
        <label
          htmlFor="fileSelect"
          className={
        ...
        <button
          onClick={uploadFiles}
          className={data.fileList.length > 0 ? "mt-4 bg-[#16abff] bg-opacity-[7%] border border-[#16abff] rounded-xl text-[#16abff] cursor-pointer text-center inline-block px-2 py-3 select-none w-[48%] focus:bg-[#0a58ca] hover:bg-[#0a58ca]" : "hidden"}
        >
          Upload
        </button>
      </div>
